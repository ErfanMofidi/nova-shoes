...
export const Details = () => {
  return (
    <div className="w-full bg-[#060609] flex flex-row justify-center border-b border-[#71717a]">
      <div className="w-full flex flex-row py-14 justify-center">

        <div className="flex flex-col w-[24%] items-center gap-2 border-r border-[#111214] mx-auto">
          <img src={lightIcon} alt="ultra light" className="w-20 h-20 opacity-60" />
          <h3 className="text-[#ededed] text-2xl uppercase">
            ultra light
          </h3>
          <p className="text-[#71717a] w-[60%] text-center">
            Reduced fatigue and helps you go the extra mile.
          </p>
        </div>

        <div className="flex flex-col w-[24%] items-center gap-2 border-r border-[#111214] mx-auto">
          <img src={cushionIcon} alt="responsive cushion" className="w-20 h-20 opacity-60" />
          <h3 className="text-[#ededed] text-2xl uppercase">
            responsive cushion
          </h3>
          <p className="text-[#71717a] w-[60%] text-center">
        ...
        <div className="flex flex-col w-[24%] items-center gap-2 border-r border-[#111214] mx-auto">
          <img src={carbonIcon} alt="carbon plate" className="w-20 h-20 opacity-60" />
          <h3 className="text-[#ededed] text-2xl uppercase">
            carbon plate
          </h3>
          <p className="text-[#71717a] w-[60%] text-center">
        ...
        <div className="flex flex-col w-[24%] items-center gap-2 mx-auto">
          <img src={breathableIcon} alt="breathable upper" className="w-20 h-20 opacity-60" />
          <h3 className="text-[#ededed] text-2xl uppercase">
            breathable upper
          </h3>
          <p className="text-[#71717a] w-[60%] text-center">
