...
export const Section2 = () => {
  return (
    <div className="border border-[#71717a] border-l-0 flex flex-row h-[50vh] overflow-hidden">
      <div className="w-[33%] bg-[#0b0b0c] pl-8 py-16 flex flex-col gap-8">
        ...
        <button className='text-[#ededed] flex flex-row gap-2 items-center cursor-pointer hover:text-[#A6DD03] transition-all ease-in duration-200 group'>
          <p>LEARN MORE</p>
